...
from character_creator import character_creator_start_handler, character_creation_handler, \
    ...
    character_bag_currency_edit_query_handler, BAG_MANAGE_SINGLE_CURRENCY_CALLBACK_DATA
    ...
    character_creator_handler = ConversationHandler(
        ...
        states={
            ...
            BAG_MANAGEMENT: [
                ...
                CallbackQueryHandler(character_bag_currency_edit_query_handler,
        ...
        name='character_creator_handler_v19',
        persistent=True
    )
